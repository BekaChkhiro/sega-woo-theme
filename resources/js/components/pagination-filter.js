 ...
 *
 * Handles pagination with AJAX.
 */
export default function paginationFilter(initialPage = 1, totalPages = 1) {
  return {
    ...
    async goToPage(page) {
      if (this.isLoading || page === this.currentPage || page < 1 || page > this.totalPages || !window.sageShopAjax) {
        return;
      }
      ...
      try {
        ...
        if (data.success) {
          ...
          // Update pagination container (this component will be replaced)
