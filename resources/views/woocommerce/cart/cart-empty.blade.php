...
@section('content')
  ...
  <div class="flex flex-col items-center justify-center py-16 text-center">
    ...
    <h2 class="mb-2 text-xl font-semibold text-secondary-900">
      {{ __('Your cart is currently empty', 'sage') }}
    </h2>

    <p class="mb-8 max-w-md text-secondary-600">
      {{ __('Looks like you haven\'t added anything to your cart yet. Browse our products and find something you\'ll love!', 'sage') }}
    </p>
    ...
    <div class="mt-16 border-t border-secondary-200 pt-12">
      <div class="mb-8 text-center">
        <h3 class="text-xl font-bold text-secondary-900">
          {{ __('Popular Products', 'sage') }}
        </h3>
        <p class="mt-2 text-secondary-600">
          {{ __('Check out some of our most popular items', 'sage') }}
        </p>
      </div>
