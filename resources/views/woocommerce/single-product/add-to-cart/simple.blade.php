      ...
      <div class="quantity-wrapper">
        ...
        <div class="flex items-center rounded-xl border border-secondary-200 bg-white shadow-sm ring-1 ring-secondary-900/5">
          ...
          <input
            ...
            inputmode="numeric"
            pattern="[0-9]*"
            class="quantity-input h-12 w-16 border-x border-secondary-300 bg-transparent text-center text-lg font-medium text-secondary-900 focus:outline-none focus:ring-0 [appearance:textfield] [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none"
        ...
        @if ($managingStock && $stockQty)
          <p id="quantity-help-{{ $productId }}" class="mt-1 text-xs text-secondary-500">
