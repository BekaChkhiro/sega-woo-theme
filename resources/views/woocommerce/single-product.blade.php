        ...
        <div class="mt-6">
            ...
            <div class="inline-flex items-center gap-2 rounded-full bg-green-50 px-4 py-2 ring-1 ring-inset ring-green-500/20">
              ...
              <span class="text-sm font-medium text-green-700">
                @if ($stockQty && $managingStock)
                  {{ sprintf(__('%d in stock', 'sega-woo-theme'), $stockQty) }}
                @else
          ...
          @elseif ($allowBackorders)
            <div class="inline-flex items-center gap-2 rounded-full bg-amber-50 px-4 py-2 ring-1 ring-inset ring-amber-500/20">
              ...
              <span class="text-sm font-medium text-amber-700">{{ __('Available on backorder', 'sega-woo-theme') }}</span>
            </div>
          @else
            <div class="inline-flex items-center gap-2 rounded-full bg-red-50 px-4 py-2 ring-1 ring-inset ring-red-500/20">
              ...
              <span class="text-sm font-medium text-red-700">{{ __('Out of stock', 'sega-woo-theme') }}</span>
            </div>
          @endif
        </div>
        ...
        @if ($purchasable && $inStock)
          <div class="mt-8">
            ...
            @elseif ($isExternalProduct)
              ...
              >
                {{ $product->get_button_text() ?: __('Buy product', 'sega-woo-theme') }}
        ...
        @elseif (!$inStock)
          ...
          <div class="mt-8 rounded-lg border border-red-200 bg-red-50 p-4">
            <p class="flex items-center gap-2 text-red-700">
              ...
              {{ __('This product is currently out of stock and unavailable.', 'sega-woo-theme') }}
            </p>
          </div>
        @endif
          ...
          <dl class="divide-y divide-secondary-200">
            @if ($productSku)
              <div class="flex items-center justify-between py-3 first:pt-0 last:pb-0">
                <dt class="text-sm font-medium text-secondary-500">{{ __('SKU', 'sega-woo-theme') }}</dt>
            ...
            @if (!empty($productCategories))
              <div class="flex flex-wrap items-start justify-between gap-3 py-3 first:pt-0 last:pb-0">
                <dt class="text-sm font-medium text-secondary-500">{{ __('Categories', 'sega-woo-theme') }}</dt>
            ...
            @if (!empty($productTags))
              <div class="flex flex-wrap items-start justify-between gap-3 py-3 first:pt-0 last:pb-0">
                <dt class="text-sm font-medium text-secondary-500">{{ __('Tags', 'sega-woo-theme') }}</dt>
      ...
      <div class="flex items-center gap-4">
        ...
        @elseif ($isVariableProduct)
          ...
          >
            ...
            {{ __('Select Options', 'sega-woo-theme') }}
          </a>
        @endif
      </div>
    </div>
